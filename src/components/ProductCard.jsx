  ...
  return (
    <div className="bg-white rounded-lg shadow-md border p-4 w-[20vw] flex flex-col justify-between mx-4">
      ...
      <div className="bg-green-50 p-3 mt-3 rounded-lg border border-green-100 text-sm text-gray-700">
        ...
        <div className="mb-1">This product has been rated for its environmental impact.</div>
        <div className="mt-2">
      ...
      <button 
        ...
        className="mt-4 bg-green-600 text-white font-semibold py-2 rounded-md hover:bg-green-700 transition-colors"
      >
        Add to Cart
      </button>
    </div>
