...
from carbon_image import estimate_carbon_from_image
from carbon_dis import estimate_carbon_from_description
from database import init_db, get_carbon_estimate, save_user_action, get_user_history
import os
